export default (libs, output) => {
  output.components.schemas.pressDrafts = libs.make.schemaObject({
    _id: libs.make.outParam('The draft ID', 'string', true, { example: 'b5dcc350-1052-4349-a271-859e44e2f80c' }),
    ...
    publicationDate: libs.make.outParam('The article publication date, if any', 'string', false, { example: '1970-12-31T23:59:59.000Z' }),
    publishedBy: libs.make.outParam('The user ID of the account that published this article, if any', 'string', false, { example: 'b5dcc350-1052-4349-a271-859e44e2f80c' }),
  });
};
