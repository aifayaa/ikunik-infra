export default (libs, output) => {
  ...
  output.components.responses.pressArticles.getAllArticles = libs.make.schemaObject({
    ...
    articles: libs.make.schemaArray(libs.make.schemaObject({
      ...
      category: libs.make.schemaObject({
        ...
        appId: libs.make.schemaRef('schemas', 'fieldAppIds'),
      ...
      userId: libs.make.outParam('The owner ID of this article', 'string', false, { example: 'b5dcc350-1052-4349-a271-859e44e2f80c' }),
      ...
      isPublished: libs.make.outParam('Whether this article is published or not', 'boolean', true),
      pictures: libs.make.schemaArray(libs.make.outParam('Article picture ID', 'string', true, { example: 'b5dcc350-1052-4349-a271-859e44e2f80c' })),
      ...
      productId: libs.make.outParam('The product ID, if any', 'string', false, { example: 'b5dcc350-1052-4349-a271-859e44e2f80c' }),
