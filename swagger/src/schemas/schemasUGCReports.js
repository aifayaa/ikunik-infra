export default (libs, output) => {
  output.components.schemas.ugcReports = libs.make.schemaObject({
    _id: libs.make.outParam('The ID of this report', 'string', true, {
    ...
    reason: libs.make.outParam('The report reason', 'string', true, {
      enum: ['inappropriate'],
    }),
    ugcId: libs.make.outParam('The reported UGC ID', 'string', true, {
      example: 'b5dcc350-1052-4349-a271-859e44e2f80c',
    }),
    userId: libs.make.outParam('The user who reported this', 'string', true, {
      example: 'b5dcc350-1052-4349-a271-859e44e2f80c',
    }),
  });
};
