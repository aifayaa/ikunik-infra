...
export default async function postLoginChecks(ret, app, checksOn) {
  ...
  try {
    const { userId } = ret;
    console.log('DEBUG postLoginChecks', app._id, userId);
    ...
    if (app.settings.userDataCollection) {
      ...
      await promiseExecUntilTrue(async () => {
        ...
        console.log('DEBUG collectSettings start');
        ...
        console.log('DEBUG collectSettings query', queryParams);
        let response = null;
        try {
        ...
        console.log('DEBUG collectSettings response', response);
        const dbOps = {};
        ...
        if (jsonataQuery) {
          ...
          console.log('DEBUG collectSettings jsonata res', result);
        ...
        console.log('DEBUG collectSettings pendingops', pendingOps);
        if (pendingOps) {
