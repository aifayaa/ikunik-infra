...
describe.skip('handlers - postPurchasableProduct', () => {
  let stubLib;
  const event = {
    requestContext: {
      authorizer: {
  ...
  describe('lib error', () => {
    ...
    describe('missing_argument', () => {
      ...
      ['contents', 'price', 'type'].forEach((key) => {
    ...
    describe('lib fail', () => {
      ...
      before(() => {
        stubLib = sandbox
          .stub(lib, 'postPurchasableProduct')
  ...
  describe('lib success', () => {
    ...
    it('should called with the good args', () => {
      ...
      sinon.assert.calledWith(stubLib, appId, userId, bodyParsed);
    });
