...
import { createFieldChecks } from '../lib/iapPollFieldsChecks';
...
export default async (event) => {
  ...
  try {
    ...
    const newIapPoll = await createIapPoll(appId, userId, bodyParsed);
    return response({ code: 200, body: newIapPoll });
  } catch (e) {
