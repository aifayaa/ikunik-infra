...
export default (libs, output) => {
  const method = libs.make.method(
    'Returns all visible child UGC from a given root UGC',
  ...
  method.responses = {
    ...
    ), // @TODO Not the exact output, some parameters are filters, others are filled from other databases, like user. Fix me.
